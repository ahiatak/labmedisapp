...
INSERT INTO user_password_history (user_id, password_hash) VALUES
    ('30000000-0000-0000-0000-000000000001','$2a$bcrypt_hash_placeholder_1_previous');
...
INSERT INTO product_packagings (product_id, level, units_per_package, is_default) VALUES
    ('44000000-0000-0000-0000-000000000001','unite',1,false),
    ('44000000-0000-0000-0000-000000000001','carton',12,true);
...
-- (entête + ligne, structure revue pour permettre plusieurs produits par retour — US-RET-01)
INSERT INTO customer_returns (id, return_number, customer_id, sale_order_id, reason, decision, decided_by_user_id, decided_at) VALUES
    ('52000000-0000-0000-0000-000000000001','RET-2026-000015','43000000-0000-0000-0000-000000000001','4e000000-0000-0000-0000-000000000001','Carton endommagé pendant le transport client','destruction','30000000-0000-0000-0000-000000000002','2026-08-27 09:00:00+00');
INSERT INTO return_lines (customer_return_id, sale_order_line_id, original_stock_lot_id, quantity) VALUES
    ('52000000-0000-0000-0000-000000000001','4f000000-0000-0000-0000-000000000001','4c000000-0000-0000-0000-000000000001',5);
...
-- ---- Notification + audit ----
INSERT INTO notifications (id, notification_type, recipient_role_id, channel, title, message, source_document_type, source_document_id) VALUES
    ('56000000-0000-0000-0000-000000000001','ReorderSuggestionCreated','20000000-0000-0000-0000-000000000003','signalr','Suggestion de réapprovisionnement urgente','France Lait 1er âge 400g : couverture 90j < délai fournisseur 110j','reorder_suggestions','55000000-0000-0000-0000-000000000001');

-- Kokou (rôle Achats) a lu la notification de rôle ; un autre membre du rôle Achats la verrait toujours comme non lue.
INSERT INTO notification_reads (notification_id, user_id) VALUES
    ('56000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001');
